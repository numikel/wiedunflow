...
```bash
uv pip install git+https://github.com/numikel/wiedunflow@${{ github.ref_name }}
```

Or download the `.whl` from the assets below and install offline:

```bash
uv pip install wiedunflow-X.Y.Z-py3-none-any.whl
```

### Usage

```bash
wiedun-flow /path/to/your/repo
```
