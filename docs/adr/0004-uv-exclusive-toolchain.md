...
- **GitHub Actions**: use `astral-sh/setup-uv@v1` (managed action).
...
- **CI configuration** — GitHub Actions workflow should use `astral-sh/setup-uv@v1` with the latest stable version.
